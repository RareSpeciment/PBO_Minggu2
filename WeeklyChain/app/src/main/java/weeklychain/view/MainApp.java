                    ...
                    if (opsiMatkul == 1) {
                        ...
                        if (opsiMatkul == 2) {
                            ...
                            for (int j = 0; j < Matkul.length; j++) {
                                if (Matkul[j] != null) {
                                    System.out.println("Matkul " + (1 + j) + " : " + Matkul[j].getNama());
                                }
                            }
                            ...
                            Matkul[editMatkul - 1].setNama(namaMatkul);
                            Matkul[editMatkul - 1].setKode(kodeMatkul);
                            Matkul[editMatkul - 1].setStatus(statusMatkul);
                            Menu();
                        } else {
                ...
                if (pilihan == 0) {
                    ...
                    if (pilihan == 1) {
                        ...
                        System.out.println("Mau Nilai Matkul apa?");
                            for (int i = 0; i < 10; i++) {
                            if (Matkul[i] != null) {
                                System.out.println((1 + i) + ". " + Matkul[i].getNama());
                            }
                        }
